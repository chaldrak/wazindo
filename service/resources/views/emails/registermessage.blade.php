        ...
        <div class="smooke_ground">
            <div class="white_ground">
                ...
                <div class="head_logo_large">
                    ...
                    Vous venez de créer un compte sur l'application Wazindo. <br>
                      Cliquez sur le bouton ci-dessous pour activer votre compte. 
                   
                        </p>
  
                     <p>
                         <a href="https://api.wazindo.com/public/api/v1/live/account/registration/confirmation/{{$code}}">
                         <button type="submit" class="styled">Activer Votre Compte</button>
    </a>
