    ...
    <div class="containerNative">
                <div class="smooke_ground">
                        <div class="white_ground">
                                    ...
                                    <strong> <p>Un nouveau code d'enregistrement vient d'être envoyé. Vérifiez vos mails </p> </strong><br><br>
                                      <p class="spams_warning">Si vous ne trouvez pas dans votre boîte de réception, vérifiez vos <strong> spams</strong></p>
                                    </div>
                                </div>          
                        </div>
